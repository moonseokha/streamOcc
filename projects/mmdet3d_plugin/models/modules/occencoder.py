...
class OccEncoder(TransformerLayerSequence):
    ...
    @force_fp32(apply_to=('reference_points', 'img_params'))
    def point_sampling(self, reference_points, pc_range,  img_params, cam_params=None):
        sensor2ego = img_params[0]['sensor2ego']
        intrin = img_params[0]['intrin']
        ...
        reference_points_cam[..., 0] /= img_params[0]['img_shape'][0][1]
        reference_points_cam[..., 1] /= img_params[0]['img_shape'][0][0]
    ...
    @force_fp32(apply_to=('reference_points', 'cam_params', 'img_params'))
    def point_sampling_fixbug(self, reference_points, pc_range, img_params, cam_params=None):
    ...
    def forward(self,
        ...
        if self.fix_bug:
            ...
            reference_points_cam, occ_mask, _ = self.point_sampling_fixbug(
                ref_3d, self.pc_range, kwargs['img_params'], cam_params=cam_params)
        else:
            ...
            reference_points_cam, occ_mask = self.point_sampling(
                ref_3d, self.pc_range, kwargs['img_params'])
